...
\begin{document}
\usetikzlibrary{ patterns, calc, arrows.meta } % Load libraries
...
\input{content/02_basics.tex}
\input{content/03_approach.tex}
\input{content/04_evaluation.tex}
% \input{content/05_approach.tex}
...
\input{content/b_acronyms.tex}
\input{content/c_notation.tex}
