...
\begin{tikzpicture}
	\node[draw, cicle, outer sep=2mm] (n10) at (0,0) {$\tau_1$};
	\node[draw, cicle, outer sep=2mm] (n20) at (-12,0) {$\tau_2$};
	\node[draw, cicle, outer sep=2mm] (n21) at (0,0) {$\tau_2$};
	\node[draw, cicle, outer sep=2mm] (n22) at (12,0) {$\tau_2$};
	\node[draw, cicle, outer sep=2mm] (n3) at (4,0) {$P=6$};
	\node[draw, cicle, outer sep=2mm] (n4) at (6,0) {$P=12$};
	\node[draw, cicle, outer sep=2mm] (n5) at (8,0) {$P=24$};
